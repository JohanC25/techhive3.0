    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('client_name', models.CharField(blank=True, max_length=255, verbose_name='Nombre cliente')),
                ...
                ('status', models.CharField(choices=[('pending', 'Pendiente'), ('in_progress', 'En proceso'), ('waiting_parts', 'Esperando repuestos'), ('completed', 'Completado'), ('delivered', 'Entregado'), ('cancelled', 'Cancelado')], default='pending', max_length=20)),
